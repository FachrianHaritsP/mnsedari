    ...
    class Pengguna_model {
        ...
        public function updatePengguna($data)
        {
            if (!isset($data['password'])) {
                $this->db->query('UPDATE pengguna SET nama = :nama, alamat = :alamat, kontak = :kontak, jabatan = :jabatan, username = :username, password = :password WHERE nip = :nip');
                $this->db->bind(':password', $data['password']);
            } else {
                $this->db->query('UPDATE pengguna SET nama = :nama, alamat = :alamat, kontak = :kontak, jabatan = :jabatan, username = :username WHERE nip = :nip');
            }
            // Bind values
            $this->db->bind(':nip', $data['nip']);
            $this->db->bind(':nama', $data['nama']);
        ...
        public function destroyPengguna($nip)
        {
